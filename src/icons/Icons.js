...
export function Github() {
    return (<a href='https://github.com/Coder-Amit' target='_blank' className='default-icons'>
...
export function Instagram() {
    return (
        <a href='https://www.instagram.com/am_tooner/' target="_blank" className='default-icons'>
...
export function LinkedIn() {
    return (
        <a href='https://www.linkedin.com/in/coder-amit-mishra/' target='_blank' className='default-icons'>
